...
#define DIALOG_TYPE_MAIN (9601)
#define DIALOG_TYPE_PAINTJOBS (9602)
#define DIALOG_TYPE_COLORS (9603)
#define DIALOG_TYPE_EXHAUSTS (9604)
#define DIALOG_TYPE_FBUMPS (9605)
#define DIALOG_TYPE_RBUMPS (9606)
#define DIALOG_TYPE_ROOFS (9607)
#define DIALOG_TYPE_SPOILERS (9608)
#define DIALOG_TYPE_SIDESKIRTS (9609)
#define DIALOG_TYPE_BULLBARS (9610)
#define DIALOG_TYPE_WHEELS (9611)
#define DIALOG_TYPE_CSTEREO (9612)
#define DIALOG_TYPE_HYDRAULICS (9613)
#define DIALOG_TYPE_NITRO (9614)
#define DIALOG_TYPE_LIGHTS (9615)
#define DIALOG_TYPE_HOODS (9616)
#define DIALOG_TYPE_VENTS (9617)
...
CMD:doxe(playerid, params[]){
    if(IsPlayerInRangeOfPoint(playerid, 4.0, 1934.689941, -2029.465576, 13.550437) || IsPlayerInRangeOfPoint(playerid, 4.0, 1935.140014, -2037.495239, 13.550437)){
        if(IsAMechanic(playerid)){
            new playerstate = GetPlayerState(playerid);
			if(playerstate == PLAYER_STATE_DRIVER){
			    return ShowPlayerDialog(playerid, DIALOG_TYPE_MAIN, DIALOG_STYLE_LIST, "Car Tuning Menu", "Paint Jobs\nColors\nHoods\nVents\nLights\nExhausts\nFront Bumpers\nRear Bumpers\nRoofs\nSpoilers\nSide Skirts\nBullbars\nWheels\nCar Stereo\nHydraulics\nNitrous Oxide\nRepair Car", "Enter", "Close");
			}else SendClientMessage(playerid, COLOR_RED, "Ban khong ngoi o tren phuong tien");
        }else SendClientMessage(playerid, COLOR_LIGHTBLUE, "Ban khong phai nguoi cua Mechanic.");
    }else SendClientMessage(playerid, COLOR_RED, "Ban can phai o noi do xe!");
    return 1;
}
...
stock MauXePlayer(playerid, id1, id2){
    for(new i = 0; i < MAX_PLAYERVEHICLES; i++)
	{
		if(IsPlayerInVehicle(playerid, PlayerVehicleInfo[playerid][i][pvId]))
		{
			PlayerVehicleInfo[playerid][i][pvColor1] = id1, PlayerVehicleInfo[playerid][i][pvColor2] = id2;
			...
			new szMessage[1280];
			format(szMessage, sizeof(szMessage), "Ban da thay doi mau sac chiec xe cua ban bang ID %d, %d.", id1, id2);
